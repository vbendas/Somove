...
**This document describes the full marketplace build (all phases).** For lean MVP scope (single-therapist, 169–219h, Cal.com embed, P1 gesture controls only), see `PRD.md` which is the authoritative MVP source of truth. This roadmap picks up where the lean MVP leaves off and describes the complete multi-practitioner platform.

**Referenced plans:**
- `PRD.md` — **Lean MVP source of truth** (single-therapist, Daily.co, Cal.com embed, P1 gestures, Stripe Checkout, 169–219h)
- `VIDEO_CALL_ROADMAP.md` — LiveKit + auto-framing
- `SCHEDULING_SYSTEM_ROADMAP.md` — Cal.com integration
- `PAYMENT_SYSTEM_ROADMAP.md` — Stripe Connect
- `CHAT_AND_SUPPORT_ROADMAP.md` — Therapist inbox + Chatwoot + Typebot
...
**Lean MVP stack (from PRD.md):** Next.js 14 · Supabase · Daily.co · Cal.com embed · MediaPipe Hands (P1) · Stripe Checkout (single sessions) · Resend · Vercel
...
**Detail:** See `VIDEO_CALL_ROADMAP.md`.
...
- [ ] **Detail:** See `VIDEO_CALL_ROADMAP.md` Phase 2
...
**Detail:** See `PAYMENT_SYSTEM_ROADMAP.md`.
...
**Detail:** See `CHAT_AND_SUPPORT_ROADMAP.md` Phases 2 and 3.
