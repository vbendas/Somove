      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        ...
        <div className="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="self-stretch text-[rgba(45,42,38,0.50)] text-sm font-medium leading-5 font-sans">
              Platform
            </div>
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="text-[rgba(45,42,38,0.50)] text-sm font-medium leading-5 font-sans">Community</div>
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="text-[rgba(45,42,38,0.50)] text-sm font-medium leading-5 font-sans">Resources</div>
            <div className="flex flex-col justify-center items-center gap-2">
              <div className="self-stretch text-[#2D2A26] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#D4A574] transition-colors">
                Privacy Policy
              </div>
              <div className="self-stretch text-[#2D2A26] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#D4A574] transition-colors">
                Terms of Service
