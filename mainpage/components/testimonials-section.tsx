...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "Somove replaced four separate tools I was paying for. Scheduling, video calls, client messaging — everything in one place. My somatic therapy practice finally has tech that understands what I do.",
      name: "Dr. Elena Vasquez",
      company: "Somatic Experiencing Practitioner, Lisbon",
      image:
    ...
    {
      quote:
        "The full-body video with gesture controls is something no other platform offers. My yoga therapy clients can move freely during sessions without touching their screen. It changed how I teach.",
      name: "Marcus Holm",
      company: "Yoga Therapist & Breathwork Instructor, Berlin",
      image:
        ...
        <div className="flex-1 py-16 md:py-17 flex flex-col md:flex-row justify-center items-end gap-6">
          <div className="self-stretch px-3 md:px-12 justify-center items-start gap-4 flex flex-col md:flex-row">
            ...
            <div className="flex-1 px-6 py-6 shadow-[0px_0px_0px_0.75px_rgba(50,45,43,0.12)] overflow-hidden flex flex-col justify-start items-start gap-6 shadow-none pb-0 pt-0">
              <div
                className="self-stretch justify-start flex flex-col text-[#2D2A26] text-2xl md:text-[32px] font-medium leading-10 md:leading-[42px] font-sans h-[200px] md:h-[210px] overflow-hidden line-clamp-5 transition-all duration-700 ease-in-out tracking-tight"
                style={{
              ...
              >
                <div className="self-stretch justify-center flex flex-col text-[rgba(45,42,38,0.90)] text-lg font-medium leading-[26px] font-sans">
                  {testimonials[activeTestimonial].name}
                </div>
                <div className="self-stretch justify-center flex flex-col text-[rgba(45,42,38,0.70)] text-lg font-medium leading-[26px] font-sans">
          ...
          <div className="pr-6 justify-start items-start gap-[14px] flex">
            <button
              ...
              className="w-9 h-9 shadow-[0px_1px_2px_rgba(0,0,0,0.08)] overflow-hidden rounded-full border border-[rgba(0,0,0,0.15)] justify-center items-center gap-2 flex hover:bg-[#FFF5E1] transition-colors"
            >
